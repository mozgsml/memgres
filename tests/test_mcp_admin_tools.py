...
def _matrix(uid: str, nsid: str, token_id: str) -> dict:
    ...
    return {
        ...
        "memory_admin_remove_member": {"space_id": nsid, "user_id": uid},
        "memory_admin_transfer_namespace": {"space_id": nsid,
                                            "new_owner_user_id": uid},
        "memory_admin_list_requests": {"space_id": nsid},
        "memory_admin_decide_access": {"request_id": uid, "approve": True},
        "memory_admin_set_disabled": {"user_id": uid, "disabled": True},
        "memory_admin_list_members": {"space_id": nsid},
        "memory_admin_issue_token": {"user_id": uid},
        "memory_admin_create_enrollment": {"user_id": uid},
        "memory_admin_list_enrollments": {},
        "memory_admin_revoke_enrollment": {"enrollment_id": uid},
