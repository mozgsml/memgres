...
| `MEMGRES_RRF_W_LEXICAL_LITERAL` | `2.0` | the lexical weight when the query carries a literal (an IP, a host, a path, `AN_ENV_KEY`) — the case where exact matching is the trustworthy one |
